...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-name', type=str, required=False, default='dataset_validation.txt', help='Path output file.')
    parser.add_argument('--data-path', type=str, required=False, default='C:\\Users\\oshen geenath\\Desktop\\code\\colorfy\\full_dataset\\Validation', help='Path to dataset')
